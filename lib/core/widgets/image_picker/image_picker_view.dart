...
import 'manger/image_manger_cubit.dart';
...
class ImageManagerView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context)=> ImageMangerCubit(),
      child: BlocConsumer<ImageMangerCubit, ImageMangerState>(
        ...
        {
          return InkWell(
            onTap: ImageMangerCubit.get(context).pickImage,
