        ...
        builder: (context, state) {
          if (AddAddressCubit.get(context).currentPosition != null)  {
            ...
            return Scaffold(
                  ...
                  children: [
                    GoogleMap(
                      ...
                      onTap: (LatLng position) {
                        ...
                        AddAddressCubit.get(context).getAddressDetails(latitude: position.latitude, longitude: position.longitude);
                        setState(() {});
                      },
                    ),
                    Positioned(
              ...
              body: AddAddressCubit.get(context).addressDetails != null ? AddNewAddressViewBody(addressDetailsModel: AddAddressCubit.get(context).addressDetails!) : AddNewAddressViewBody(),
            );
          }
