...
import 'package:restaurant/features/home/presentation/views/widgets/all_restaurants_view_body.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('All Restaurants', style: Styles.textStyle18),
      ),
      body: AllRestaurantsViewBody(),
    );
  }
}
